...
class WeatherDetails extends Component {
  ...
  render() {
   ...
   <div>
        <div
      style={{background: '#FFFFFF', boxShadow: '0px 4px 32px rgba(143, 143, 143, 0.4)', borderRadius: '4px', padding: '10px',
       marginTop: '10px'   , marginLeft: '15%',  marginRight: '15%'}}
      >
      <span
    ...
    <br/>
      ...
      <div
      style={{background: '#FFFFFF', boxShadow: '0px 4px 32px rgba(143, 143, 143, 0.4)', borderRadius: '4px', 
      padding: '10px', marginTop: '10px' ,  paddingBottom: '10px'  , marginLeft: '15%',  marginRight: '15%'}}>
               <AddComment/>    
      </div>
      <br/>
      <br/>
